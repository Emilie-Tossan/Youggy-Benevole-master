				...
				<View style={styles.droidSafeArea}>
					...
					<View style={styles.mainContainer}>
						...
						<Text style={styles.subText}>
							...
							. Pour participer aux missions, ouvre le et cliques
							sur le lien qui apparaît pour confirmer ton adresse
							e-mail.
						</Text>
					</View>
					<View />
				</View>
				<View style={{ top: hp('-15.3%') }}>
					<BottomButton
						text='Je vais voir mes e-mails'
						navigate={() => {
							const url =
								Platform.OS === 'ios'
									? 'mail://'
